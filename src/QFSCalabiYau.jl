...
# MARK - state-of-the-art algorithms
#
# These are the fastest algorithms we have for calculating 
# the quasi-F-split height
#
# * classic naive algorithm `quasiFSplitHeight_CY_lift`
# * classic algorithm with gpu delta1 `quasiFSplitHeight_CY_lift_gpu`
# * merge-based algorithm with cpu delta1 `quasiFSplitHeight_CY_lift_sort`
# * merge-based algorithm with gpu delta1 `quasiFSplitHeight_CY_lift_sort_gpu`
# * TODO: merge-based algorithm with gpu delta1 and gpu matmul
# * TODO: heuristic algorithm based on p, d, and gpu availability
#
